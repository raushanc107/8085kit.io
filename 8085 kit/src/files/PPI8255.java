...
public class PPI8255 {
    ...
    {
        PortAaddress=engine.Hex2Dec(o.jTable8255[2][1].toString());
        PortBaddress=engine.Hex2Dec(o.jTable8255[2][1].toString());
        PortCaddress=engine.Hex2Dec(o.jTable8255[2][1].toString());
        CRaddress=engine.Hex2Dec(o.jTable8255[2][1].toString());
    }
     public void get() {
        PortAin=engine.Hex2Dec(o.jTable8255[0][2].toString());
